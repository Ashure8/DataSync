...
namespace @out
{
    public partial class Form1 : Form
    {
        ...
        //这个是测试注释
        private const string conn_mes = "Server=127.0.0.1;user id=sa;password=Aa123456;initial catalog=UFTData545228_900000;Connect Timeout=30;Persist Security Info=True;Current Language=Simplified Chinese;pooling=false";
        private const string constring = "data source=127.0.0.1;port=3306;database=yongyou_zjedu_st_2025;user id=st;password=123456;pooling=true;charset=utf8;SslMode=None;";
